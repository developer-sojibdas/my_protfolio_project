...
/>
                ...
                <p className="p service__text p__color">close to the earth.</p> <br />
                <a href="#" className="project__btn">HIRE</a>
              </div>
            </div>
          </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <a href="#" className="project__btn">HIRE</a> </div>
            </div>
          </div>
        </div>
      </div>
